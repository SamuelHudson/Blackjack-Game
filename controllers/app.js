...
// .directive ('validationTool', function(){
//     return {
//         require: 'ngModel',
//         scope: {
//           maxAmount: '=',
...
//                 //if chipstack is more than the proposed bet and 
//                 //the proposed amount is more than the minimum amount
//                 if(value <= $scope.maxAmount && value >= $scope.minAmount){
//                     mCtrl.$setValidity("MyMaxValidation", true);
//                 }
//                 //else it is invalid
//                 else {
//                     mCtrl.$setValidity("MyMaxValidation", false);
//                 }

//                 //no negative integers allowed
//                 // if (value < $scope.minAmount) {
//                 //     mCtrl.$setValidity("MyMinValidation", false);
//                 // }
//                 // else {
//                 //     mCtrl.$setValidity("MyMinValidation", true);
//                 // }
//                 // return value;
//             }
